async function fetchProductCatalog() {
    try {
        ...
        const orderedData = orderData(data.products);
        // 1.uzdevums:
        console.log(data);
        // -----------

        // 2.uzdevums:
        displayProductCatalog(orderedData);
        // ----------
...
function orderData(data) {
    let orderData = data.sort((a, b) => a.price - b.price)
    return orderData;
}
...
function displayProductCatalog(products) {
    ...
    products.forEach(product => {
      ...
      `;
        productCatalogContainer.appendChild(productCard);
    });
}
