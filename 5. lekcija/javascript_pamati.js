...
//         break
//     default:
//         console.log('Lūdzu, ievadi dienu!')
// }
...
// function calculateSum(calculateSumArray) {
//     let sum = 0;
//     calculateSumArray.forEach(num => sum += num);
//     return sum
//   }
// --VAI--
// function calculateSum(calculateSumArray) {
//     let sumOfArray = calculateSumArray.reduce((accumulator, currentValue) => accumulator + currentValue);
//     console.log(sumOfArray)
// }
// calculateSum([3, 6, 7]);
...
function compareStrings(input) {
    console.log('start');
    const tomatoe = 'tomatoe';
    const result = tomatoe.localeCompare(input);
    console.log(result === 0);
    console.log(input == tomatoe);
    console.log(input.toLowerCase() === tomatoe)
}
compareStrings('Tomatoe ');
compareStrings('tomatoe');
